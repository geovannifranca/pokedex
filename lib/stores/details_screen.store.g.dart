...
part of 'details_screen.store.dart';
...
mixin _$DetailsScreenStore on DetailsScreenStoreBase, Store {
  late final _$isLoadingAtom = Atom(
    name: 'DetailsScreenStoreBase.isLoading',
    context: context,
  );
  ...
  late final _$pokemonDetailsAtom = Atom(
    name: 'DetailsScreenStoreBase.pokemonDetails',
    context: context,
  );
  ...
  late final _$getPokemonDetailsDataAsyncAction = AsyncAction(
    'DetailsScreenStoreBase.getPokemonDetailsData',
    context: context,
  );
